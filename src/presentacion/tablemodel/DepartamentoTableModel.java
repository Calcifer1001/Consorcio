...
public class DepartamentoTableModel extends AbstractTableModel{
	...
	private String[] nombreColumnas = {"Unidad", "Nombre Propietario", "Nombre CoPropietario", "Saldo Actual", "Total a Pagar"};
	
	//Tipo de cada columna
	
	private Class[] tiposColumnas = {Integer.class, String.class, String.class, Float.class, Float.class};
	
	private ArrayList<Departamento> contenido = new ArrayList<Departamento>();
...
//	}
	...
	public ArrayList<Departamento> getContenido(){
		return contenido;
	}
	
	public void setContenido(ArrayList<Departamento> contenido) {
